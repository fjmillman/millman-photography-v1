<?php $this->layout('base', ['pages' => $pages]) ?>
...
<section id="blog">
    <div class="container">
            ...
            <?php foreach ($blogItems as $blogItem): ?>
                <div class="col-md-4 col-sm-6 project-item">
                    <a href="<?= $this->e($blogItem['link']) ?>" class="project-link">
                        <img src="/public/image/<?= $this->e($blogItem['image']) ?>" class="img-fluid" alt="">
                    </a>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <button type="submit" class="btn btn-xl">Check out my Blog</button>
            </div>
        </div>
    </div>
</section>
...
<!-- About -->
<section id="about" class="fix-panel-background">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
        ...
        <div class="row">
            <div class="col-lg-6 text-center">
                <img src="http://millmanphotography.dev/image/portrait.jpg" aria-label="Portrait" class="img-fluid portrait">
            </div>
            <div class="col-lg-6 text-center">
...
<section id="gallery">
    <div class="container">
            ...
            <?php foreach ($galleryItems as $galleryItem): ?>
                <div class="col-md-4 col-sm-6 project-item">
                    <a href="<?= $this->e($galleryItem['link']) ?>" class="project-link">
                        <img src="/public/image/<?= $this->e($galleryItem['image']) ?>" class="img-fluid" alt="">
                    </a>
                    <div class="project-caption">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <button type="submit" class="btn btn-xl">Check out my Gallery</button>
            </div>
        </div>
    </div>
</section>
...
<!-- Services -->
<section id="services" class="fix-panel-background">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
        ...
        <div class="row text-center service-group">
            <div class="col-md-4">
