...
class Version20170606153100 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        foreach ($posts as $post) {
            $this->addSql(
                'INSERT INTO `post` (`id`, `user_id`, `title`, `slug`, `description`, `body`, `date_created`, `date_modified`)
                 VALUES (:id, :user_id, :title, :slug, :description, :body, :date_created, :date_modified)',
                $post
            );
        }
